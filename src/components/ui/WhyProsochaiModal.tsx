...
export default function WhyProsochaiModal({ onClose }: Props) {
  useEffect(() => {
    ...
    >
      <div className="relative w-full max-w-2xl rounded-2xl bg-white shadow-2xl ring-1 ring-gray-200 my-8">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4 sticky top-0 bg-white rounded-t-2xl z-10">
          <h2 className="text-lg font-bold text-gray-900">Why Prosochai?</h2>
          <button
            onClick={onClose}
            aria-label="Close"
        ...
        <div className="px-6 py-6 space-y-6 text-[1.0rem] leading-relaxed text-gray-700">
          ...
          <p>
            ...
            <ExtLink href="https://decisionlab.vse.cz/english/">Decision Lab</ExtLink>{' '}
            ...
            <ExtLink href="https://locusworkspace.com/">Locus Workspace</ExtLink>{' '}
          ...
          <div className="space-y-4">
            <Term id="prosochai" term="Prosochai">
            ...
            <Term id="pomodoro" term="Pomodoro">
              ...
              <ExtLink href="https://en.wikipedia.org/wiki/Pomodoro_Technique">Learn more →</ExtLink>
            </Term>
            <Term id="nudge" term="Nudge">
              ...
              <ExtLink href="https://en.wikipedia.org/wiki/Nudge_theory">Learn more →</ExtLink>
            </Term>
          </div>
        </div>

        <div className="border-t border-gray-100 px-6 py-4 text-center sticky bottom-0 bg-white rounded-b-2xl">
          <button
            onClick={onClose}
...
function Term({ id, term, children }: { id: string; term: string; children: React.ReactNode }) {
  return (
    <div id={id} className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
